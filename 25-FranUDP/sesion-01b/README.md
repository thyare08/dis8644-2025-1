...
#### [Transistor](https://youtu.be/AwXp6jVaTV4?si=FOLykgKZMbyUZYDo)
...
#### Modulo amplificador [PAM8403](https://www.alldatasheet.com/datasheet-pdf/pdf/1132029/DIODES/PAM8403.html)
...
#### Modulo relé ([relay](https://youtu.be/n594CkrP6xE?si=hkM1zjmvYs7owK3e) module)

Electrically operated switch (button), like transistors, but slower and can handle higher power.
...
When given current emits a predetermined noice (ender 3 thermal runaway flashbacks)
