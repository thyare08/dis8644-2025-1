...
>> <img align="left" src="./files/Through-Hole-Soldering.jpg" width=300> <br/> <br/> The iron heats up both surfaces we want to join for a second or two, then we add the solder wire, after it melts we remove it and wait a couple seconds before removing the iron <br/> <br/> <br/> <br/>
>> 
...
> 
>
> 3.- Cada 2 o 3 soldaduras limpiar la punta (paso 2), ya que el estaño al permanecer caliente mucho tiempo pierde sus propiedades y se <br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;hace más difícil de utilizar <br/> <br/>
>
...
>> ### Switches
>>> ### PS-535
>>> <img align="left" src="./files/PS-535.jpg" width=260> <img align="left" src="./files/NO.png" width=130> Es un Push button switch Normally Open (NO) <br/> Algo curioso de este interruptor es que los signos + (derecha) y - (izquierda) señalizan incorrectamente cuales son las terminales del botón, ya que tras testearlo con el multímetro encontré que las terminales son los pines de arriba y abajo (destacados en azul) <br/><br/><br/><br/><br/><br/><br/>
>>>
>>> ### 7mm Push button NO
>>> <img align="left" src="./files/7mm.jpg" width=260> <img align="left" src="./files/NO.png" width=130> Interruptor NO que cuenta con un hilo (rosca) para fijarlo al *"enclosure/case"* con una tuerca. <br/> En sus patas tiene agujeros para pasar un cable por allí antes de soldarlo (same as with through hole components) <br/><br/><br/><br/><br/><br/><br/><br/>
>>
>> ### Base dip (IC Socket)
...
>> <img align="left" src="./files/tips.jpg" width=500> Cónicas: De propósito general y para detalles precisos (dependiendo del tamaño) <br/><br/> Cuchillo: Se usa para esparcir y quitar estaño <br/><br/> Cincel: Permite calentar un área más grande que la cónica <br/><br/> Angulada (plana): Permite calentar una gran área y esparcir más estaño <br/><br/> Angulada (cavidad): Igual que la anterior, pero puede acumular más estaño <br/><br/>
>> 
> <br/> 
