...
>> * .Cu: <img align="right" src="./files/Cu.png" width=100> Considerando que en la zona donde está el gráfico no hay un plano sólido de cobre, esté se verá de un tono más claro, ya que generará un trazo de cobre bajo la superficie de la PCB <br/><br/><br/><br/><br/>
>>
>> * .Silkscreen: <img align="right" src="./files/silk.png" width=100> Poner el gráfico en esta capa hará que lo impriman sobre la superficie de la pcb con tinta blanca <br/><br/><br/><br/><br/><br/>
>>
