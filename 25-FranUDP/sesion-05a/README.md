...
>> Conecté 2 capacitores en paralelo, con un potenciómetro entre 2 de sus teminales en un intento de variar la capacitancia del segundo <img align="left" src="./files/capacitorFalstad.gif" width=490>  capacitor, teniendo en cuenta que una mayor resistencia hace que un capacitor se cargue más lento + el 555 descargando y cargando los capacitores constantemente = el segundo capacitor no alcanzaría a cargarse completamente antes de volver a descargarse. <br/> <br/>
...
>> <img align="left" src="./files/555HowWorks.jpg" width=600>
> ### Other things
>
>> #### SUB_SUBTITULO
-----------------------------------------------------------------------------------------------------------
