...
<img align="left" src="./archivos/cmyk.jpg" width=300></br></br></br> CMYK es utilizado para diseñar imágenes para impresión, se podría decir que a diferencia de RGB que se utiliza para imágenes digitales, CMYK se utiliza para imágenes analógicas. Obtiene su nombre a partir de las tintas empleadas para impresión (Cyan, Magenta, Yellow & Key [negro]</br></br></br>
...
> ### LM324 op amp
><img align="left" src="./archivos/LM324-pinout.jpg" width=300></br></br> Este Op Amp (Operational Amplifier) está compuesto por 4 comparadores (LM741 x 4)</br></br> Los comparadoores de los circuitós se comportan igual que el comparador de minecraft (modo comparador), pero en lugar de comparar la intensidad de la señal de redstone, comparan el voltaje que hay en cada terminal. </br></br></br></br></br></br></br>
<img align="left" src="./archivos/compSymb1.jpg" width=300><img align="left" src="./archivos/compSymb2.jpg" width=229></br> Aquí podemos apreciar los 2 símbolos que representan a los comparadores en los esquemas. El símbolo de la izquierda es el símbolo completo, ya que el comparador requiere una conección a una fuente de poder, además de las líneas que está comparando, para poder trabajar. Mientras que en la derecha tenemos el símbolo simplificado, que no muestra las conecciones a la fuente de poder.</br> Se emplea el simplificado cuando se quiere entender la lógica con la que se está trabajando sin confundirse con las demás conecciónes, que se sabe estan allí, pero no son necesarias para entender el funcionamiento del circuito (en algunos casos).</br></br></br></br>
